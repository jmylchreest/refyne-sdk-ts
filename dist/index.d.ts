import * as createClient from 'openapi-fetch';
import createClient__default from 'openapi-fetch';
...
declare const DEFAULT_BASE_URL = "https://api.refyne.uk";
...
declare class JobsClient {
    ...
    getResults(id: string, options?: {
        merge?: boolean;
    }): Promise<openapi_typescript_helpers.SuccessResponse<{
        200: {
            headers: {
                [name: string]: unknown;
            };
...
declare class SchemasClient {
    ...
    /** Get a schema by ID. */
    get(id: string): Promise<SchemaOutput>;
    /** Create a new schema. */
    create(input: components['schemas']['CreateSchemaInputBody']): Promise<SchemaOutput>;
    /** Update a schema. */
    update(id: string, input: components['schemas']['UpdateSchemaInputBody']): Promise<SchemaOutput>;
    /** Delete a schema. */
...
declare class SitesClient {
        ...
        sites: {
            analysis_result?: {
                ...
                follow_patterns: {
                    description: string;
                    pattern: string;
                    sample_urls?: string[] | null | undefined;
                }[] | null;
                page_type: string;
                recommended_fetch_mode: string;
                sample_links: string[] | null;
            ...
            crawl_options?: {
                follow_pattern?: string | undefined;
                follow_selector?: string | undefined;
                max_depth?: number | undefined;
                max_pages?: number | undefined;
            } | undefined;
            created_at: string;
            default_schema_id?: string | undefined;
            domain: string;
            fetch_mode: string;
            id: string;
    ...
    get(id: string): Promise<SavedSiteOutput>;
    /** Create a new saved site. */
    create(input: components['schemas']['CreateSavedSiteInputBody']): Promise<SavedSiteOutput>;
    /** Update a saved site. */
    update(id: string, input: components['schemas']['UpdateSavedSiteInputBody']): Promise<SavedSiteOutput>;
    /** Delete a saved site. */
    delete(id: string): Promise<{
        success: boolean;
    }>;
...
declare class LLMClient {
    ...
    listProviders(): Promise<{
        providers: {
            base_url_hint?: string | undefined;
            description: string;
            display_name: string;
            docs_url?: string | undefined;
            key_placeholder?: string | undefined;
            name: string;
            required_features?: string[] | null | undefined;
            requires_key: boolean;
        }[] | null;
    }>;
    ...
    upsertKey(input: components['schemas']['UserServiceKeyInput']): Promise<{
        base_url?: string | undefined;
        created_at: string;
        has_key: boolean;
        id: string;
    ...
    setChain(input: components['schemas']['SetUserFallbackChainInputBody']): Promise<{
        chain: {
            created_at: string;
            id: string;
            is_enabled: boolean;
 ...
 * ```
 */
declare class Refyne {
    /** Static builder for fluent construction */
    static Builder: typeof RefyneBuilder;
     ...
     */
    get rawClient(): createClient.Client<paths, `${string}/${string}`>;
    /**
 ...
 * ```
 */
declare class RefyneError extends Error {
    ...
    constructor(message: string, status: number, detail?: string, response?: Response);
}
/**
 ...
 * ```
 */
declare class RateLimitError extends RefyneError {
    /** Seconds to wait before retrying */
    readonly retryAfter: number;
    constructor(message: string, retryAfter: number, detail?: string, response?: Response);
}
/**
 ...
 */
declare class ValidationError extends RefyneError {
    /** Field-level validation errors */
    readonly errors?: Record<string, string[]>;
    constructor(message: string, errors?: Record<string, string[]>, response?: Response);
}
/**
 ...
 * ```
 */
declare class UnsupportedAPIVersionError extends RefyneError {
    ...
    constructor(apiVersion: string, minVersion: string, maxKnownVersion: string);
}
/**
 ...
 */
declare class TLSError extends RefyneError {
 ...
 */
declare class AuthenticationError extends RefyneError {
 ...
 */
declare class ForbiddenError extends RefyneError {
    constructor(message?: string, response?: Response);
}
/**
 * Error thrown when a requested resource is not found.
 */
declare class NotFoundError extends RefyneError {
    constructor(message?: string, response?: Response);
}
...
declare const MIN_API_VERSION = "0.0.0";
/** Maximum API version this SDK was built against */
declare const MAX_KNOWN_API_VERSION = "0.0.0";
/**
 * Detect the current runtime environment.
 * @returns Runtime name and version string
 */
declare function detectRuntime(): {
    name: string;
    version: string;
};
/**
